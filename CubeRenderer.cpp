...
Vector3 CubeRenderer::CalculatePolygonNormal(Vector3 p1, Vector3 p2, Vector3 p3) {
...
void CubeRenderer::CalculateVertexNormals() {
...
void CubeRenderer::Render(CBuffer constantBuffer)
{
...
void CubeRenderer::BuildGeometryBuffers() {
...
void CubeRenderer::BuildShaders() {
...
void CubeRenderer::BuildVertexLayout()
{
...
void CubeRenderer::BuildRasteriserState() {
