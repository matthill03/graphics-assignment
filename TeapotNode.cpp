...
void TeapotNode::CalculateVertexNormals()
{
...
Vector3 TeapotNode::CalculatePolygonNormal(Vector3 p1, Vector3 p2, Vector3 p3)
{
...
void TeapotNode::PopulateTeapotVertices()
{
